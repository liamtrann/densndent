...
exports.getItemsByClass = async (req, res) => {
  try {
    ...
    const items = await itemsService.findByField(
      "class",
      classId,
      limit,
      offset,
...
exports.getItemsByClassAndBrand = async (req, res) => {
  try {
    const { classId, brand, limit, offset, sort, minPrice, maxPrice } =
      req.query;
    if (!classId || !brand) {
      return res.status(400).json({ error: "classId and brand are required" });
    }
    const items = await itemsService.findByClassAndBrand(
      classId,
      brand,
      limit,
      offset,
...
exports.postGetItemsByParent = async (req, res) => {
  try {
    ...
    const items = await itemsService.findByParent(
      parent,
      limit,
      offset,
      sort,
...
exports.getItemsByIds = async (req, res) => {
  try {
    ...
    const items = await itemsService.findByIds(
      ids,
      limit,
      offset,
      sort,
...
exports.getCountByClass = async (req, res) => {
  try {
    ...
    const count = await itemsService.countByField(
      "class",
      classId,
      minPrice,
      maxPrice
...
exports.getItemsByCategory = async (req, res) => {
  try {
    ...
    const items = await itemsService.findByCategory(
      category,
      limit,
      offset,
      sort,
...
exports.getCountByCategory = async (req, res) => {
  try {
    ...
    const count = await itemsService.countByCategory(
      category,
      minPrice,
      maxPrice
    );
...
exports.getAllProducts = async (req, res) => {
  try {
    const { limit, offset, sort, minPrice, maxPrice } = req.query;
    const items = await itemsService.findAllProducts(
      limit,
      offset,
      sort,
      minPrice,
