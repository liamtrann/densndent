...
router.get("/by-external-id", controller.getTransactionByExternalId);
router.get("/by-user-order-history", controller.getItemsByUserOrderHistory);
router.get(
  "/order-details-by-transaction",
  controller.getOrderDetailsByTransaction
);
