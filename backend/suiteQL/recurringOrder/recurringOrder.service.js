...
class RecurringOrderService {
  ...
  async getDueOrders(limit, offset) {
    const sql = `SELECT ro.id, ro.custrecord_ro_customer AS customerid, c.email AS customeremail, ro.custrecord_ro_item AS itemid, ro.custrecord_ro_quantity AS quantity, ro.custrecord_ro_interval AS interval, iu.name AS intervalunit, ro.custrecord_ro_next_run AS nextrun, ro.custrecord_prefer_delivery AS preferdelivery, i.displayname, ip.price, (SELECT f.url FROM file f WHERE f.isonline = 'T' AND f.name LIKE '%' || i.displayname || '%' ORDER BY f.createddate DESC FETCH FIRST 1 ROWS ONLY) AS file_url FROM ${this.NS_CUSTOM_RECORD_SCRIPTID} ro LEFT JOIN customlist_interval_unit iu ON iu.id = ro.custrecord_ro_interval_unit LEFT JOIN customlist_recurring_order_status st ON st.id = ro.custrecord_ro_status LEFT JOIN item i ON i.id = ro.custrecord_ro_item LEFT JOIN itemprice ip ON ip.item = i.id AND ip.pricelevel = 1 LEFT JOIN customer c ON c.id = ro.custrecord_ro_customer WHERE ro.custrecord_ro_status = '1' AND ro.custrecord_ro_next_run <= CURRENT_DATE ORDER BY ro.custrecord_ro_next_run ASC`;
  ...
  async getAllRecurringOrders(limit, offset) {
    const sql = `SELECT ro.id, ro.custrecord_ro_customer AS customerid, ro.custrecord_ro_item AS itemid, ro.custrecord_ro_quantity AS quantity, ro.custrecord_ro_interval AS interval, iu.name AS intervalunit, ro.custrecord_ro_next_run AS nextrun, ro.custrecord_prefer_delivery AS preferdelivery, st.name AS status, i.displayname, ip.price, (SELECT f.url FROM file f WHERE f.isonline = 'T' AND f.name LIKE '%' || i.displayname || '%' ORDER BY f.createddate DESC FETCH FIRST 1 ROWS ONLY) AS file_url FROM ${this.NS_CUSTOM_RECORD_SCRIPTID} ro LEFT JOIN customlist_interval_unit iu ON iu.id = ro.custrecord_ro_interval_unit LEFT JOIN customlist_recurring_order_status st ON st.id = ro.custrecord_ro_status LEFT JOIN item i ON i.id = ro.custrecord_ro_item LEFT JOIN itemprice ip ON ip.item = i.id AND ip.pricelevel = 1 ORDER BY ro.custrecord_ro_next_run DESC`;
  ...
  async getRecurringOrdersByCustomer(customerId, limit, offset) {
    ...
    const sql = `SELECT ro.id, ro.custrecord_ro_customer AS customerid, ro.custrecord_ro_item AS itemid, ro.custrecord_ro_quantity AS quantity, ro.custrecord_ro_interval AS interval, iu.name AS intervalunit, ro.custrecord_ro_next_run AS nextrun, ro.custrecord_prefer_delivery AS preferdelivery, st.name AS status, i.displayname, ip.price, (SELECT f.url FROM file f WHERE f.isonline = 'T' AND f.name LIKE '%' || i.displayname || '%' ORDER BY f.createddate DESC FETCH FIRST 1 ROWS ONLY) AS file_url FROM ${this.NS_CUSTOM_RECORD_SCRIPTID} ro LEFT JOIN customlist_interval_unit iu ON iu.id = ro.custrecord_ro_interval_unit LEFT JOIN customlist_recurring_order_status st ON st.id = ro.custrecord_ro_status LEFT JOIN item i ON i.id = ro.custrecord_ro_item LEFT JOIN itemprice ip ON ip.item = i.id AND ip.pricelevel = 1 WHERE ro.custrecord_ro_customer = '${customerId}' AND ro.custrecord_ro_status IN ('1', '2') ORDER BY ro.custrecord_ro_next_run DESC`;
  ...
  async getActiveRecurringOrders(limit, offset) {
    const sql = `SELECT ro.id, ro.custrecord_ro_customer AS customerid, ro.custrecord_ro_item AS itemid, ro.custrecord_ro_quantity AS quantity, ro.custrecord_ro_interval AS interval, iu.name AS intervalunit, ro.custrecord_ro_next_run AS nextrun, ro.custrecord_prefer_delivery AS preferdelivery, st.name AS status, i.displayname, ip.price, (SELECT f.url FROM file f WHERE f.isonline = 'T' AND f.name LIKE '%' || i.displayname || '%' ORDER BY f.createddate DESC FETCH FIRST 1 ROWS ONLY) AS file_url FROM ${this.NS_CUSTOM_RECORD_SCRIPTID} ro LEFT JOIN customlist_interval_unit iu ON iu.id = ro.custrecord_ro_interval_unit LEFT JOIN customlist_recurring_order_status st ON st.id = ro.custrecord_ro_status LEFT JOIN item i ON i.id = ro.custrecord_ro_item LEFT JOIN itemprice ip ON ip.item = i.id AND ip.pricelevel = 1 WHERE ro.custrecord_ro_status = '1' ORDER BY ro.custrecord_ro_next_run ASC`;
