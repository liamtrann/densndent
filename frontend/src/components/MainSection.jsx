    ...
    <main className="p-6 grid grid-cols-12 gap-6">
      ...
      <section className="col-span-9 space-y-6">
        <div className="bg-white rounded-xl shadow-md p-6 flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-smiles-orange mb-2">Fluorides, Toothbrushes & Floss</h1>
            <p className="text-lg text-smiles-orange">Up to 35% Off</p>
            <p className="text-gray-600 mb-3">+ Exclusive Special Offers</p>
            <Button variant="primary" className="px-5 py-2">Shop Now</Button>
            <p className="text-xs text-gray-500 mt-1">Promo Code: WA | Expires June 30</p>
          </div>
          <Image src="/products-banner.png" alt="Hero Banner" className="h-44 object-contain" />
        </div>
        ...
        <div className="grid grid-cols-3 gap-4">
          {[
            ...
            <div key={label} className="bg-white rounded-lg shadow-sm p-3 hover:shadow-md transition">
              <Image src={img} alt={label} className="w-full h-40 object-cover rounded" />
