...
export default function PartnersPage() {
  return (
    <div className="px-4 py-12 max-w-7xl mx-auto text-gray-800">
      ...
      <h1 className="text-4xl font-light text-orange-500 text-center mb-4">
        Our Partners
      </h1>
      <Paragraph className="text-center mb-8 max-w-3xl mx-auto">
        We proudly partner with the industry’s leading brands to bring you the
        highest quality dental and medical products. Below are some of our
        trusted partners.
      </Paragraph>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6 items-center justify-center">
        {partners.map(({ key, url, name }) => (
          <div
            key={key}
            className="flex items-center justify-center p-4 bg-white border rounded shadow-sm hover:shadow-md transition"
          >
            <Image
              src={url}
              alt={name}
